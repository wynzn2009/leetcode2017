...
/**
 * @author 015422404 我们有两个长度相等且不为空的整型数组 A 和 B 。
 * 
 ...
 * 
 *         示例: 输入: A = [1,3,5,4], B = [1,2,3,7] 输出: 1 解释: 交换 A[3] 和 B[3]
 *         后，两个数组如下: A = [1, 3, 5, 7] ， B = [1, 2, 3, 4] 两个数组均为严格递增的。 注意:
 * 
 *         A, B 两个数组的长度总是相等的，且长度的范围为 [1, 1000]。 A[i], B[i] 均为 [0, 2000]区间内的整数。
 * 
 */
