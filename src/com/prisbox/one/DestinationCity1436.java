...
/**
 * @author wynzn 给你一份旅游线路图，该线路图中的旅行线路用数组 paths 表示，其中 paths[i] = [cityAi, cityBi]
 ...
 *         提示：
 * 
 *         1 <= paths.length <= 100 paths[i].length == 2 1
 *         <= cityAi.length, cityBi.length <= 10 cityAi != cityBi
 *         所有字符串均由大小写英文字母和空格字符组成。
 * 
 *         来源：力扣（LeetCode） 链接：https://leetcode-cn.com/problems/destination-city
