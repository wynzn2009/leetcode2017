...
/**
 * @author 015422404 给定一位研究者论文被引用次数的数组（被引用次数是非负整数）。编写一个方法，计算出研究者的 h 指数。
 * 
...
public class HIndex274 {
	...
	public static void main(String[] args) {
		...
		System.out.print(HIndex274.hIndex(citations));
	}
